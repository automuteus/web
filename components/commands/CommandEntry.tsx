...
function CommandEntry(props: Props): React.ReactElement {
  ...
  return (
    <div className={`commandEntry`} id={entry.command} ref={myRef}>
      ...
      >
        ...
        <div className="entryToggle ml-auto">
          <FontAwesomeIcon
            icon={faChevronDown}
            style={{
            ...
            <div className="mb-4">
              ...
              {opt_args.length > 0 && (
                <>
                  ...
                  <h6>Optional</h6>
                  <div>
                    <ArgTable cmd={entry.command} args={opt_args} />
                  </div>
                </>
              )}
            </div>
